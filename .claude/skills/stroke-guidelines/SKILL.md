---
name: stroke-guidelines
description: Domain knowledge for acute ischemic stroke, intracerebral hemorrhage, and thrombectomy. Loaded by medical-scientist, calculator-engineer, and clinical-reviewer when work touches these domains.
---

Load this skill when the task involves acute ischemic stroke, ICH, or thrombectomy. Contains canonical guideline references, evidence classification tables, key trials, validation checklists, and dangerous patterns to catch. All clinical content is sourced from AHA/ASA 2026 (ischemic stroke) and AHA/ASA 2022 (ICH).
...
**How to access:**
- WebFetch the URL directly: https://www.ahajournals.org/doi/10.1161/STR.0000000000000513
...
### Per AHA/ASA 2026 (Ischemic Stroke)
