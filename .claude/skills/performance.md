---
name: performance
description: Domain knowledge for Core Web Vitals, bundle size optimization, code splitting, image optimization, caching strategies, and performance budgets. Loaded by qa-engineer and ui-architect when performance budgets are in scope.
---

Performance optimization knowledge for NeuroWiki. Loaded by qa-engineer and ui-architect when performance budgets, Core Web Vitals, or bundle size are in scope for the current task.
