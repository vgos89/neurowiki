...
description: Clinical algorithm implementer. Builds and maintains scoring logic, interpretation thresholds, and calculator UI patterns. Clinical content routes to medical-scientist; interpretation prose routes through clinical-reviewer before merge. Contextual agent — activates on calculator tasks.
