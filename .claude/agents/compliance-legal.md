...
description: Contextual agent. Owns HIPAA/GDPR/CCPA/ADA compliance, medical disclaimers, legal protection. Activates on auth, privacy, public-facing legal content only.
...
This agent is no longer dormant — it is now a contextual activation.
