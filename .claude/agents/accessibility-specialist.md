...
- Interactive UI components (forms, modals, dialogs, calculators, custom inputs)
- New ARIA patterns or attribute changes
...
For pure layout, token, or copy-only changes, this agent is NOT loaded.
