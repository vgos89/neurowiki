...
### WOVEN — Alexander MJ et al., J Neurointerv Surg 2021 (PMID 32561658) — added Phase 2 (2026-07-30)
- **§8a Accompanying editorial.** WOVEN is a single-arm registry follow-up of the WEAVE on-label Wingspan cohort. No paired editorial is expected for a descriptive post-market surveillance report, and none was located (searched 2026-07-30). Not applicable.
- **§8b Post-publication letters / replies.** None located in free sources, searched 2026-07-30.
- **§8c Guideline incorporation.** WOVEN is not separately named in AHA/ASA, AAN, or ESO guidance. The relevant anchor is the AHA/ASA 2021 SP §5.5 recommendation on on-label Wingspan stenting after recurrent stroke despite medical therapy (Class 2b, LOE B-R, citing WEAVE). WOVEN adds 1-year durability context to the WEAVE 72-hour safety signal; it changes no recommendation class.
- **§8d Subsequent meta-analyses / later evidence.** No subsequent RCT or meta-analysis is specific to WOVEN. The randomized ICAS-endovascular evidence that followed is CASSISS (2022, no benefit) and BASIS (2024, positive for submaximal balloon angioplasty), both covered above; WOVEN remains descriptive single-arm safety-durability data with no efficacy claim and no pre-specified 1-year threshold.

**§8 verification note:** §8a/§8c for CASSISS, BASIS, and WOVEN and the BASIS editorial identity are verified. §8b for all three is an explicit "searched, none located" declaration. §8d is verified at abstract/summary level; the CASSISS long-term Stroke 2024 paper and pooled effect framings were located via search but not full-text-read (flagged; none of this §8d material is quoted in rendered trial-card content). WOVEN was authored and rendered in Phase 2 (2026-07-30); the Phase-1 "deferred" note above is retained as history.
