  ...
  'step-1': { // Last Known Well
    quick: [
      ...
      },
      {
        ...
        content: 'TRACE-III (ICA or MCA occlusion): TNK 4.5–24h without EVT access gives about 1 in 11 patients mRS 0–1. AHA/ASA 2026 §4.6.3 grades late-window IVT for any LVO at COR 2b, LOE B-R, and names no agent. TIMELESS did not demonstrate benefit when rapid EVT was available. Route to EVT when available.',
        type: 'trial',
        section: 'step-1',
    ...
    deep: [
      ...
      },
      {
        ...
        section: 'step-1',
        link: '/trials/wake-up',
        evidence: 'NEJM 2018; AHA/ASA 2026 §4.6.3 Rec 1 (COR 2a, LOE B-R)',
        evidenceClass: 'IIa',
        evidenceLevel: 'B',
      },
      {
        ...
        section: 'step-1',
        link: '/trials/extend',
        evidence: 'NEJM 2019; AHA/ASA 2026 §4.6.3 Rec 2 (COR 2a, LOE B-R)',
        evidenceClass: 'IIa',
        evidenceLevel: 'B',
      ...
      },
      {
        ...
        content: 'ECASS III excluded these patients from its 3-4.5h randomization (not 0-3h): Age >80, NIHSS >25, any oral anticoagulant use (regardless of INR), prior stroke + diabetes, imaging shows >1/3 MCA territory infarct. These are trial entry criteria, not guideline exclusions. AHA/ASA 2026 §4.6.2 Rec 1 recommends IV thrombolysis across the whole 0-4.5h window (COR 1, LOE A) with no age, NIHSS, anticoagulant or prior-stroke-plus-diabetes carve-out. Many centres still apply the ECASS III criteria by local protocol.',
        type: 'pearl',
        section: 'step-1',
        evidenceClass: 'I',
        evidenceLevel: 'B',
        plainEnglish: 'These are ECASS III trial entry criteria, not AHA/ASA 2026 exclusions. Check your local protocol.',
        evidence: 'ECASS III 2008 trial entry criteria. Not carried forward as exclusions by AHA/ASA 2026.',
      },
      {
      ...
      },
      {
        ...
        evidence: 'Albers GW et al, NEJM 2024. AHA/ASA 2026 cites TIMELESS in the §4.6.3 recommendation-specific supportive text as limiting evidence for the 4.5 to 24 hour recommendation, and assigns the trial itself no COR or LOE.',
        plainEnglish: 'When rapid EVT is available, late-window TNK has not been shown to add benefit. Reserve TRACE-III framing for centers without EVT access.',
        pmid: '38329148',
        nctId: 'NCT03785678',
  ...
  'step-2': { // LVO Screening
    quick: [
      ...
      },
      {
        ...
        content: 'Basilar artery occlusion with baseline mRS 0–1, NIHSS ≥10, and PC-ASPECTS ≥6: EVT within 24h of onset is Class 1, LOE A. The guideline gives one 24h window; the 12h (ATTENTION) and 6–24h (BAOCHE) figures are the trial enrolment windows, not separate strata. mRS 0–3 roughly doubles in both trials; ATTENTION (≤12h) cut mortality 55% to 37%, while BAOCHE (6–24h) showed a non-significant 42% to 31% trend.',
        type: 'trial',
        section: 'step-2',
        link: '/trials/baoche',
    ...
    deep: [
      ...
      },
      {
        ...
        content: 'Chinese trial in 455 adults with anterior LVO within 24h LKW, ASPECTS 3–5 or core 70–100 mL on perfusion imaging. EVT plus medical care vs medical care alone. Ordinal mRS at 90 days: generalized OR 1.37 (95% CI 1.11–1.69), P=0.004 favoring EVT. mRS 0–3 at 90 days: 47.0% vs 33.3%. sICH 6.1% vs 2.7% (P=0.12). AHA/ASA 2026 §4.7.2 Rec 3: Class 1, LOE A.',
        type: 'trial',
        section: 'step-2',
        ...
        detailedContent: {
          ...
          clinicalTips: [
            ...
            'sICH numerically higher with EVT (6.1% vs 2.7%, P=0.12). Discuss bleeding risk in consent.',
          ],
          evidence: 'Ordinal-shift design (generalized OR). gOR 1.37 (95% CI 1.11–1.69), P=0.004; mRS 0–3 47.0% vs 33.3%; sICH 6.1% vs 2.7% (P=0.12). Stopped early for efficacy. Overestimation caveat. Quoted: "In a trial conducted in China, patients with large cerebral infarctions had better outcomes with endovascular therapy administered within 24 hours than with medical management alone but had more intracranial hemorrhages."',
      ...
      },
      {
        ...
        content: 'European-Canadian trial in 253 adults with anterior LVO and ASPECTS 3–5 by NCCT only (no advanced imaging required), up to 12h LKW. EVT vs medical care alone. Ordinal mRS at 90 days: adjusted common OR 2.58 (95% CI 1.60–4.15), P=0.0001 favoring EVT. Mortality 40% vs 51% (P=0.038). sICH 6% vs 5%; NCCT-only selection did not increase hemorrhage. Stopped early at first interim. Contributes to AHA/ASA 2026 §4.7.2 Class 1, LOE A.',
        type: 'trial',
        section: 'step-2',
        link: '/trials/tension',
        ...
        detailedContent: {
          ...
          clinicalTips: [
            ...
            'sICH 6% with thrombectomy vs 5% with medical treatment alone; selection by NCCT did not increase bleeding compared to historic CTP-selected cohorts.',
            'Stopped early at first interim for efficacy. Effect size may be overestimated.',
            'Ordinal-shift primary outcome. Do not compute NNT.',
          ],
          evidence: 'Ordinal-shift design (adjusted common OR). aOR 2.58 (95% CI 1.60–4.15), P=0.0001; mortality 40% vs 51% (P=0.038); sICH 6% vs 5%. Stopped early; overestimation caveat applies. Quoted: "Endovascular thrombectomy was associated with improved functional outcome and lower mortality in patients with acute ischaemic stroke from large vessel occlusion with established large infarct in a setting using non-contrast CT as the predominant imaging modality for patient selection."',
      ...
      },
      {
        ...
        content: 'Chinese trial in 217 adults with basilar artery occlusion, 6–24h from symptom onset or last seen well, PC-ASPECTS ≥6, NIHSS ≥6 (post-amendment). 2:1 randomization to EVT vs best medical care. mRS 0–3 at 90 days (binary primary, amended from 0–4 during trial): 46% (EVT) vs 24% (medical); adjusted RR 1.81 (95% CI 1.26–2.60), P<0.001. sICH 6% vs 1% (NNH ≈ 20). AHA/ASA 2026 §4.7.3 Rec 1: Class 1, LOE A for basilar AO with baseline mRS 0–1, NIHSS ≥10, PC-ASPECTS ≥6, within 24h from symptom onset. NIHSS 6–9 with the same criteria is Class 2b, LOE B-R (not well established), so the BAOCHE post-amendment NIHSS ≥6 entry is broader than the Class 1 recommendation.',
        type: 'trial',
        section: 'step-2',
        link: '/trials/baoche',
        ...
        evidenceClass: 'I',
        evidenceLevel: 'A',
        plainEnglish: 'Basilar occlusion, 6–24h, NIHSS ≥6 at entry (the AHA/ASA recommendation is written at NIHSS ≥10), PC-ASPECTS ≥6: EVT works. Roughly 1 in 5 additional patients reach mRS 0–3.',
        pmid: '36239645',
        nctId: 'NCT02737189',
      ...
      },
      {
        ...
        content: 'Chinese trial in 340 adults with basilar artery occlusion within 12h, NIHSS ≥10, randomized 2:1 to EVT vs best medical care. mRS 0–3 at 90 days: 46% vs 23%; adjusted RR 2.06 (95% CI 1.46–2.91), P<0.001. Mortality 37% vs 55%. sICH 5% vs 0%. AHA/ASA 2026 §4.7.3 Rec 1: Class 1, LOE A for basilar AO with baseline mRS 0–1, NIHSS ≥10, and PC-ASPECTS ≥6, within 24h of onset. Stopped early for efficacy.',
        type: 'trial',
        section: 'step-2',
        ...
        detailedContent: {
          overview: 'ATTENTION enrolled the early window (≤12h) for basilar AO in parallel with BAOCHE (6–24h). Both published in the same NEJM issue, and together they moved basilar EVT to Class 1, LOE A for baseline mRS 0–1, NIHSS ≥10, and PC-ASPECTS ≥6 within a single 24h window measured from symptom onset.',
          clinicalTips: [
    ...
    deep: [
      {
        ...
        type: 'pearl',
        section: 'step-4',
        evidence: 'ENCHANTED 2019, ENOS 2015',
        evidenceClass: 'I',
        evidenceLevel: 'B',
      },
      {
      ...
      },
      {
        ...
        type: 'pearl',
        section: 'step-4',
        evidence: 'SITS-ISTR 2009; ENCHANTED 2019; OPTIMAL-BP JAMA 2023; ENCHANTED2/MT Lancet 2022',
        evidenceClass: 'I',
        evidenceLevel: 'B',
      },
      {
  ...
  'step-5': { // Treatment Orders
    ...
    deep: [
      ...
      },
      {
        ...
        content: '441 cryptogenic stroke patients randomized to implantable cardiac monitor vs standard monitoring. AF detection with the implantable monitor vs standard care: 8.9% vs 1.4% at 6 months, 12.4% vs 2.0% at 12 months, and 30% vs 3% at 36 months. Changed practice: extended monitoring (30 days minimum) for cryptogenic stroke.',
        type: 'trial',
        section: 'step-5',
  ...
  'step-6': { // Complications
    ...
    deep: [
      ...
      },
      {
        ...
        content: 'Tranexamic acid in spontaneous ICH. 2,325 patients. TXA did not improve functional outcomes; possible increase in thromboembolic events. 2022 AHA/ASA ICH: the effectiveness of TXA to improve functional outcome is not well established (COR 2b, LOE B-R). That is a statement of uncertainty, not a prohibition. This does not extend to post-thrombolysis sICH, where TXA is given as part of the reversal bundle (AHA/ASA 2026 Table 5, an ungraded management-options table).',
        type: 'trial',
        section: 'step-6',
        link: '/trials/tich-2',
        evidence: 'Lancet 2018; AHA/ASA 2022 ICH General Hemostatic Treatments rec 2 (COR 2b, LOE B-R)',
        evidenceClass: 'IIb',
        evidenceLevel: 'B',
      },
      {
        ...
        content: 'For mild-to-moderate ICH presenting with SBP 150-220, acute lowering to a target of SBP 140 (goal range 130-150) may be reasonable within 1 hour (Class IIb, Level B-R). Avoid SBP <130, which is potentially harmful (Class III); avoid a rapid drop of more than 90 mmHg in the first hour. INTERACT-2 and ATACH-2 both missed their primary endpoints. Use nicardipine or labetalol. Contrast with ischemic stroke: in ICH lower BP reduces expansion; in ischemic stroke too low worsens penumbral perfusion.',
        type: 'pearl',
        section: 'step-6',
        evidence: 'AHA/ASA 2022 ICH Guidelines, Section 5.1, Class IIb, Level B-R; INTERACT-2, ATACH-2',
        evidenceClass: 'IIb',
        evidenceLevel: 'B',
      },
      {
        id: 'atach2-trial',
        title: 'ATACH-2 Trial',
        content: 'Intensive BP lowering (110-139) vs standard (140-179) in spontaneous ICH. No difference in death or disability; intensive arm had possible harm (e.g. renal). 2022 guidelines: target SBP 140 with a goal range of 130-150 may be reasonable within 1 hour (Class IIb, Level B-R); avoid SBP <130.',
        type: 'trial',
        section: 'step-6',
        link: '/trials/atach-2',
      ...
      },
      {
        ...
        content: 'STAT neurosurgery consult for: Cerebellar hemorrhage with neurological decline, brainstem compression and/or hydrocephalus from ventricular obstruction, OR a volume of 15 mL or more, any one of which is sufficient on its own (immediate surgical removal with or without EVD; COR 1, Level B-NR). EVD is separately COR 1, Level B-NR for large IVH with impaired level of consciousness. Superficial lobar ICH with mass effect + declining GCS (STICH II-type). Any ICH with herniation signs. STICH I and STICH II: no demonstrated benefit for open craniotomy in supratentorial ICH, including the dedicated superficial lobar population (STICH II primary endpoint not met: 59% vs 62% unfavorable, OR 0.86, 95% CI 0.62–1.20, P=0.367). Deep hemorrhages (basal ganglia, thalamus) generally managed medically.',
        type: 'pearl',
        section: 'step-6',
      ...
      },
      {
        id: 'stich-trial',
        title: 'STICH Trials',
        content: 'Surgery for spontaneous ICH. STICH I: No overall benefit. STICH II: no overall benefit; possible benefit in select superficial lobar hemorrhages (<1cm from cortex) with mass effect. Deep hemorrhages managed medically. 2022 AHA/ASA ICH: for most supratentorial ICH of moderate or greater severity the usefulness of craniotomy is uncertain (COR 2b, LOE A); in patients who are deteriorating, craniotomy might be considered as a lifesaving measure (COR 2b, LOE C-LD).',
        type: 'trial',
        section: 'step-6',
        link: '/trials/stich',
        evidence: 'Lancet 2005, 2013; AHA/ASA 2022 ICH Craniotomy for Supratentorial Hemorrhage recs 1 and 2',
        evidenceClass: 'IIb',
        evidenceLevel: 'A',
      },
    ],
