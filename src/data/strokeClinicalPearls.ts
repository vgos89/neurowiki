  ...
  'step-2': { // LVO Screening
    quick: [
      ...
      },
      {
        ...
        content: 'Basilar artery occlusion with NIHSS ≥10 and PC-ASPECTS ≥6: EVT is Class 1, LOE A within 12h (ATTENTION) and 6–24h (BAOCHE). mRS 0–3 roughly doubles in both trials; ATTENTION (≤12h) cut mortality 55% to 37%, while BAOCHE (6–24h) showed a non-significant 42% to 31% trend.',
        type: 'trial',
        section: 'step-2',
        link: '/trials/baoche',
