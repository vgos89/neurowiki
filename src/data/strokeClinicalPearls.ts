    ...
    deep: [
      ...
      },
      {
        ...
        detailedContent: {
          ...
          evidence: 'Ordinal-shift design (adjusted common OR). aOR 2.58 (95% CI 1.60–4.15), P=0.0001; mortality 40% vs 51% (P=0.038); sICH 5% vs 5% (NS). Stopped early — overestimation caveat. Quoted: "Endovascular thrombectomy was associated with improved functional outcome and lower mortality in patients with acute ischaemic stroke from large vessel occlusion with established large infarct in a setting using non-contrast CT as the predominant imaging modality for patient selection."',
      ...
      },
      {
        ...
        detailedContent: {
          ...
          evidence: 'Superiority trial, binary primary (mRS 0–3 at 90d). mRS 0–3 46% vs 23%; adjusted RR 2.06 (95% CI 1.46–2.91), P<0.001; mortality 37% vs 55%; sICH 5% vs 0%. NNT appropriate for binary primary; ARD ~23 percentage points. Stopped early — overestimation caveat. Quoted: "Among Chinese patients with acute ischemic stroke due to basilar-artery occlusion, the addition of endovascular thrombectomy to best medical care within 12 hours after symptom onset resulted in better functional outcomes at 90 days than best medical care alone but was associated with procedural complications and intracerebral hemorrhage."',
