...
const manualTrials: (Omit<TrialItem, 'year'> & { year?: number })[] = [
  ...
  buildTrial('pc-trial', 'PC Trial', 'secondary-prevention', '10.1056/NEJMoa1211716', {
    isPlaceholder: false,
    description: 'International RCT (N=414, age <60) of Amplatzer PFO Occluder vs medical therapy after cryptogenic stroke, TIA, or peripheral embolism. Primary composite 3.4% vs 5.2% (HR 0.63, P=0.34). Underpowered: only 18 primary events. Negative.',
    year: 2013,
  }),
