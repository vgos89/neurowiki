...
export const MEDICAL_GLOSSARY: Record<string, string> = {
  ...
  'absolute-risk-reduction': 'The raw percentage-point difference in outcome rates between two groups. ARR = treatment rate minus control rate. Directly tells you how many extra patients per 100 benefit from treatment.',
  'arr': 'Absolute Risk Reduction: the raw percentage-point difference in outcome rates between two groups. ARR = treatment rate minus control rate. Tells you how many extra patients per 100 benefit.',
  'relative-risk-reduction': 'The proportional reduction in risk compared to control: RRR = ARR divided by control rate. A 20% RRR means treatment reduced events by 20% relative to control. Can overstate benefit when baseline risk is low.',
  'rrr': 'Relative Risk Reduction: the proportional reduction in risk compared to control. RRR = ARR divided by control rate. Can overstate benefit when baseline risk is low.',
  'number-needed-to-harm': 'Number Needed to Harm: how many patients must be treated for one additional patient to experience a harmful outcome. Higher is safer. NNH = 1 divided by absolute risk increase for harm.',
  'nnh': 'Number Needed to Harm: how many patients must be treated for one additional patient to experience a harmful outcome. Higher is safer.',
  'risk-ratio': 'Ratio of outcome rate in the treatment group to outcome rate in the control group. RR = 1 means no difference; RR greater than 1 means treatment increases the outcome; RR less than 1 means treatment reduces it. Distinct from odds ratio in calculation.',
  'rr': 'Risk Ratio: ratio of outcome rate in treatment group to control group. RR = 1.44 means the treatment group is 1.44 times as likely to achieve the outcome. Different from odds ratio.',
