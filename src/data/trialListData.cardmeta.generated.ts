...
export const TRIAL_CARD_META: Record<string, TrialCardMeta> = {
  ...
  "rescue-bt-trial": {
    ...
    "bottomLineSummary": "Chinese double-blind placebo-controlled trial of peri-procedural IV tirofiban vs placebo during thrombectomy in LVO stroke within 24 hours. This is the trial behind the AHA/ASA 2026 COR 3: No Benefit (LOE B-R) against preoperative tirofiban before EVT. Adjusted common OR 1.08 (95% CI 0.86-1.36, P = 0.50): no functional benefit. Symptomatic ICH numerically higher with tirofiban, not significant (9.7% vs 6.4%, difference 3.3%, 95% CI −0.2% to +6.8%). No benefit, with an unfavourable safety trend.",
