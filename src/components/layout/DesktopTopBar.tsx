...
// Search is a stub button only — no overlay (LAYOUT_SPEC §0.1).
...
export const DesktopTopBar: React.FC = () => (
  <header className="hidden md:flex h-[60px] bg-white border-b border-slate-100 items-center px-8 gap-4">
    ...
    <button
      type="button"
      className="flex items-center gap-2.5 bg-slate-50 border border-slate-100 rounded-full px-4 py-2 w-full max-w-[520px] text-left cursor-pointer"
