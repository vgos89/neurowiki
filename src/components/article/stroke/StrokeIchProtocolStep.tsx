...
export const ICH_PROTOCOL_ITEMS = [
  ...
  { title: 'Blood pressure', detail: 'Mild-to-moderate ICH with SBP 150-220: lower to a target of SBP 140, aiming to hold 130-150, starting within 2 hours and reaching target within 1 hour. Nicardipine or labetalol. Do NOT go below SBP 130, which is potentially harmful; avoid rapid drop (>90 mmHg in 1 h). Safety and efficacy of intensive lowering are not established in large or severe ICH or when surgical decompression is needed.', evidence: 'AHA/ASA 2022 ICH: COR 2b, LOE B-R for the 140 target; COR 3: Harm, LOE B-R for lowering below 130; INTERACT2, ATACH-2' },
