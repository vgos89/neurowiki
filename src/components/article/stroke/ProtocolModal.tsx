...
export function ProtocolModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-4">
      ...
      >
        {/* Header — chassis-aligned 2026-05-24: slate-50 tint so the
            modal header visually matches the chassis card header bars
            used across the Stroke Code pathway. Title remains prominent
            for dialog accessibility (aria-labelledby target). */}
        <div className="flex-shrink-0 px-6 pt-5 pb-4 bg-slate-50 border-b border-slate-100 flex items-start justify-between gap-4">
          <div>
