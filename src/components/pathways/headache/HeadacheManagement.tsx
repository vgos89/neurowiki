 ...
 * ClinicHeadachePathway.tsx (the former inline treatment block, page 716–865).
 * No dosing, threshold, grade, drug, or qualifier text is changed — verbatim
 * relocation is a hard requirement of the clinical-review gate
 ...
 *
 * SectionHeader / Row moved here verbatim from the page (their only consumer).
 */
