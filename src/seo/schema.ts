  ...
  '/pathways/evt': [
    {
      ...
      answer: 'Per AHA/ASA 2026 guidelines, EVT is indicated for acute ischemic stroke from a large vessel occlusion (LVO) involving the internal carotid artery, M1 or M2 segment of the middle cerebral artery, in patients with pre-stroke mRS 0–2. Within the first 6 hours, EVT is indicated regardless of ASPECTS score. In the extended 6–24 hour window, EVT requires clinical-imaging mismatch (DAWN criteria) or perfusion mismatch (DEFUSE-3 criteria). Basilar artery occlusion is governed separately: a single 0–24 hour window from symptom onset with baseline mRS 0–1 and PC-ASPECTS ≥6, stratified by severity (NIHSS ≥10 is COR 1, LOE A; NIHSS 6–9 is COR 2b, LOE B-R). A major 2026 update: large core infarct (ASPECTS 3–5) is now a COR 1 indication based on SELECT-2 and ANGEL-ASPECT trials, demonstrating benefit even with large established infarcts. NIHSS ≥6 is a common practical threshold, though lower scores with disabling deficits may also qualify. Patient age alone is not an exclusion criterion.',
    },
    {
      question: 'What is the EVT time window for stroke thrombectomy?',
      answer: 'The EVT time window has two phases. The early window (0–6 hours from last known well) permits thrombectomy for any LVO without perfusion imaging requirements; ASPECTS does not preclude eligibility. The extended window (6–24 hours) requires additional imaging: DAWN criteria (clinical-imaging mismatch: infarct core ≤51 mL for age ≥80 or ≤31 mL for NIHSS ≥10 and age <80) or DEFUSE-3 criteria (core <70 mL, mismatch ratio ≥1.8, mismatch volume ≥15 mL). For basilar artery occlusion with baseline mRS 0–1, NIHSS ≥10, and PC-ASPECTS ≥6, EVT within 24 hours from symptom onset is recommended (COR 1, LOE A per AHA/ASA 2026 §4.7.3, based on ATTENTION and BAOCHE). For NIHSS 6–9 with the same imaging and baseline criteria, effectiveness within 24 hours is not well established (COR 2b, LOE B-R). Wake-up stroke with favorable perfusion imaging also qualifies at experienced centers. Every 30-minute reduction in time-to-reperfusion significantly improves functional outcomes; time is neurons.',
    },
    {
...
const QUESTION_META: Record<string, { title: string; description: string; answer: string }> = {
  ...
  'lvo-evt': {
    ...
    answer: 'EVT is COR 1 for ICA or M1 occlusion within 6 h based on the HERMES meta-analysis (MR CLEAN, ESCAPE, EXTEND-IA, SWIFT PRIME, REVASCAT). Basilar occlusion is COR 1 within 24 h from symptom onset when baseline mRS is 0 or 1, NIHSS is 10 or above, and PC-ASPECTS is 6 or above. Late-window EVT (6–24 h) requires clinical-imaging mismatch (DAWN) or perfusion mismatch (DEFUSE-3). Large-core EVT (ASPECTS 3–5) is now COR 1 based on five positive RCTs: RESCUE-Japan LIMIT, SELECT2, ANGEL-ASPECT, TENSION, and LASTE. ESCAPE-MeVO and DISTAL did not establish benefit for medium-vessel or distal occlusions.',
  },
  'anticoagulation': {
  ...
  'basilar-evt': {
    ...
    answer: 'Early basilar EVT trials BEST (2020, stopped early; substantial crossover) and BASICS (2021, neutral; 80% of controls received IV alteplase) did not establish benefit. Two later Chinese trials, ATTENTION (2022, 0–12 h) and BAOCHE (2022, 6–24 h, stopped early for benefit), both showed improved functional outcomes with EVT. AHA/ASA 2026 §4.7.3 recommends basilar EVT within 24 h of onset for baseline mRS 0–1, NIHSS ≥10 and PC-ASPECTS ≥6 (COR 1, LOE A); for NIHSS 6–9 with the same criteria the effectiveness is not well established (COR 2b, LOE B-R). The guideline gives one 24 h window stratified by severity; the 12 h and 6–24 h figures are trial enrolment windows. BAOCHE was stopped early and effect size may be overestimated.',
  },
  'ich-surgery': {
    ...
    answer: 'STICH I (2005) and STICH II (2013) found no overall benefit from open craniotomy for supratentorial ICH, though STICH II suggested directional benefit in superficial lobar hemorrhage. MISTIE III (2019) showed minimally invasive catheter aspiration plus tPA reduced clot volume but did not improve mRS at 1 year. ENRICH (2024), using a Bayesian design, showed minimally invasive parafascicular surgery improved 180-day utility-weighted mRS in lobar ICH; the anterior basal ganglia stratum was stopped for futility at the second interim analysis, so the benefit does not extend to it. ENRICH supports a new role for minimally invasive surgery in selected lobar ICH; AHA/ASA 2022 guidelines pre-date ENRICH and rate minimally invasive surgery COR 2b.',
  },
  'msu-dispatch': {
  ...
  'pfo-antithrombotic-choice': {
    ...
    answer: 'No adequately powered randomized trial has ever compared anticoagulation with antiplatelet therapy in a PFO-selected population. Every dataset is a subgroup or an underpowered arm: PICSS (Circulation 2002) is a non-prespecified subgroup of a substudy, 98 patients, using low-intensity warfarin (INR 1.4 to 2.8), giving 4 of 42 versus 10 of 56, HR 0.52 (95% CI 0.16 to 1.67). CLOSE (NEJM 2017) ran a parallel anticoagulation comparison it was not powered for: 3 of 187 versus 7 of 174, HR 0.44 (95% CI 0.11 to 1.48). NAVIGATE-ESUS (Lancet Neurology 2018) reported a prespecified PFO subgroup at 45% power after the trial stopped early for futility and bleeding: HR 0.54 (95% CI 0.22 to 1.36), interaction p=0.18. RE-SPECT ESUS (Stroke 2021) found a null PFO interaction, p=0.8290, and concluded there is insufficient evidence to recommend anticoagulation over antiplatelet therapy. A pooled signal does exist and it decayed as trials accumulated: the 2018 pooled OR of 0.48 (0.24 to 0.96) became OR 0.70 (0.43 to 1.14) in 2021 when RE-SPECT ESUS was added to the same pool by the same method, and Chi 2025 (9 RCTs, 15,451 patients) found no PFO interaction at all, p=0.28. The bleeding excess is the reproducible finding and runs the other way: major bleeding other than intracranial haemorrhage RR 1.69 (1.18 to 2.43). The AAN 2020 practice advisory treats the two as equally acceptable (Statement 3a, Level C) and notes that the high end of its confidence interval also rules out a clinically important benefit for aspirin. BMJ Rapid Recommendations 2018 made a weak recommendation for anticoagulation on low-quality evidence; no society adopted it. Antiplatelet therapy is the default because it is simpler and safer and anticoagulation was never shown to be better, not because anticoagulation was beaten. The RoPE score estimates how likely the PFO is causal rather than incidental, which is how far this evidence reaches for a given patient; it is a probability estimate, not a threshold, and none of these trials stratified by it. CLOSE-2 (NCT05387954) is recruiting and is expected to settle the question, with primary completion in July 2031.',
  },
  'pfo-closure-migraine': {
    ...
    answer: 'Three randomized trials have tested PFO closure for migraine and all three missed their primary endpoint. MIST (Circulation 2008, N=147, STARFlex vs sham) found migraine cessation in 3 of 74 vs 3 of 73 (P=0.51). PRIMA (Eur Heart J 2016, N=107, Amplatzer vs medical therapy, unblinded with no sham) found a reduction of 2.9 vs 1.7 monthly migraine days (P=0.17). PREMIUM (JACC 2017, N=230, Amplatzer vs sham right heart catheterization, double-blind) found a responder rate of 38.5% vs 32.0% (P=0.32); its co-primary safety endpoint was met, meaning the procedure was safe but not effective for migraine. Every positive figure attached to these trials is secondary, subgroup, or post-hoc: aura-specific measures in PRIMA (P=0.014) and headache days and complete remission in PREMIUM (P=0.025 and P=0.01). The 2021 pooled analysis (JACC) is not pooled sham-controlled evidence: it combined PRIMA and PREMIUM (N=337) using re-defined endpoints and excluded MIST, and its conventional responder rate of 38% vs 29% was not significant (P=0.13). SCAI 2022 suggests against routine use for migraine (conditional, moderate certainty), allowing that a patient with debilitating refractory migraine may reasonably choose closure after shared decision-making. VA/DoD 2023 Recommendation 40 is Weak against; that guideline keeps a separate insufficient-evidence category and did not place PFO closure in it.',
  },
