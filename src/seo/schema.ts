...
const QUESTION_META: Record<string, { title: string; description: string; answer: string }> = {
  ...
  'lvo-evt': {
    ...
    answer: 'EVT is COR 1 for ICA or M1 occlusion within 6 h based on the HERMES meta-analysis (MR CLEAN, ESCAPE, EXTEND-IA, SWIFT PRIME, REVASCAT). Basilar occlusion is COR 1 within 24 h when baseline mRS is 0 or 1, NIHSS is 10 or above, and PC-ASPECTS is 6 or above. Late-window EVT (6–24 h) requires clinical-imaging mismatch (DAWN) or perfusion mismatch (DEFUSE-3). Large-core EVT (ASPECTS 3–5) is now COR 1 based on five positive RCTs: RESCUE-Japan LIMIT, SELECT2, ANGEL-ASPECT, TENSION, and LASTE. ESCAPE-MeVO and DISTAL did not establish benefit for medium-vessel or distal occlusions.',
  },
  'anticoagulation': {
