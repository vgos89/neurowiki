    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-5 pt-6 pb-4">
        ...
        <CalculatorFooter
          ...
          disclaimer="Educational use only. All TIA patients need urgent evaluation. ABCD² does not include imaging; consider ABCD²-I if DWI available. Do not use to delay workup."
        />
