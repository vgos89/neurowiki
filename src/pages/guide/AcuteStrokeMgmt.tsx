    ...
    >
      {(viewMode) => (
        <>
          ...
          <Paragraph
            viewMode={viewMode}
            detail="NIHSS &gt;20, carotid T, early CT hypodensity = high risk. HOB 30°, mannitol or 3% saline. Hemicraniectomy within 24–48 h for malignant cerebral edema with neurological deterioration: COR 1 in patients &le;60 y (AHA/ASA 2026); may be considered in selected patients &gt;60 y (COR 2b, LOE B-R; stated benefit is mortality reduction alone)."
          >
            <strong>Malignant edema:</strong> ~80% mortality untreated. Risk: <Term detail="NIH Stroke Scale">NIHSS</Term> <Value>&gt;20</Value>, carotid T, early hypodensity. HOB <Value>&gt;30°</Value>, hyperosmolar therapy. <Critical>Hemicraniectomy</Critical> within 24–48 h: COR 1 if &le;60 y; COR 2b if &gt;60 y (mortality benefit only).
          </Paragraph>
