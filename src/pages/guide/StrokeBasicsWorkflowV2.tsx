...
const StudyPearlsButton: React.FC<{ count: number; onClick: () => void }> = ({ count, onClick }) =>
  count > 0 ? (
    <button
      type="button"
      onClick={onClick}
      className="min-h-[44px] flex items-center gap-1.5 px-3 py-2 rounded-lg bg-neuro-50 border border-neuro-200 text-neuro-700 hover:bg-neuro-100 transition-colors text-xs font-semibold mb-3 focus-visible:ring-2 focus-visible:ring-neuro-500 focus-visible:outline-none"
    >
            ...
            <div className="flex items-center justify-between px-4 py-3">
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={handleBack}
                  className="flex items-center justify-center min-h-[44px] min-w-[44px] rounded-lg hover:bg-slate-100 transition-colors cursor-pointer bg-transparent border-0 focus-visible:ring-2 focus-visible:ring-neuro-500 focus-visible:outline-none"
                  aria-label="Back"
                >
              ...
              <div className="flex items-center gap-1 bg-slate-100 rounded-lg p-1" role="radiogroup" aria-label="Workflow mode">
                <button
                  ...
                  className={`min-h-[44px] px-3 py-2 rounded-md text-xs font-semibold transition-all focus-visible:ring-2 focus-visible:ring-neuro-500 focus-visible:outline-none ${
                    workflowMode === 'code'
          ...
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[80] flex items-center justify-center p-4">
            ...
            >
              <div className="flex items-center justify-between h-12 px-4 bg-slate-50 border-b border-slate-100 flex-shrink-0">
                ...
                <button ref={nihssModalCloseRef} onClick={() => setNihssModalOpen(false)} className="min-h-[44px] min-w-[44px] rounded-full bg-slate-100 hover:bg-slate-200 transition-colors flex items-center justify-center focus-visible:ring-2 focus-visible:ring-neuro-500 focus-visible:outline-none" aria-label="Close NIHSS calculator">
