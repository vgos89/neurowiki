  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      ...
      <Section title="Saved cases (My Cases)">
        ...
        <p>
          <span className="font-medium text-slate-700">How timestamp storage is chosen.</span> The save dialog picks the right default based on what you actually captured. When stroke-code timestamps are filled in your session (Code Activation, CT Read, etc.), the dialog defaults to keeping wall-clock times so door-to-needle and door-to-puncture metrics work. When no stroke-code timestamps were captured, the dialog defaults to elapsed offsets (e.g., "+12m from anchor") so the saved record can't be tied back to a specific time of day. You can flip the checkbox either way before saving — the label tells you what each state does.
        </p>
        <p>
