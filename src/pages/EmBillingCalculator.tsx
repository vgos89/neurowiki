        ...
        <div className="mt-4 border-t border-slate-200 pt-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10 text-center">
            {[
              ...
              <div key={code} className="bg-slate-50 border border-slate-200 rounded-lg px-3 py-3">
                ...
                <div className="text-xs text-slate-400 mt-0.5">{time} or High MDM</div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-6">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              ...
              Each specialty comes with pre-populated MDM examples for common diagnoses, imaging, labs, and management risk levels. Use the NPI lookup to auto-populate your specialty from the CMS NPPES registry.
            </p>
          </div>
