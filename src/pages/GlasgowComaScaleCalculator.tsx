...
const SEVERITY_TOKENS: Record<GCSSeverity, SeverityTokens> = {
  low: {
    borderColor: '#e2e8f0',
    headerBg: 'bg-white',
  ...
  return (
    <>
      ...
      <CalculatorDrawer
        ...
        ariaContentId="gcs-drawer-content"
        stateAText={{ label: '0 of 3 selected', hint: 'Appears when complete' }}
        stateBText={{ label: `${selectedCount} of 3 selected`, hint: `${3 - selectedCount} more to complete` }}
