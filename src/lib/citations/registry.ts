...
export const CITATION_REGISTRY: CitationRegistry = {
  ...
  'ichd3-2018': {
    ...
    year: 2018,
    section: '1.1, 1.2, 1.3, 1.4.1, 2.2, 2.3, 3.1, 3.2, 3.3, 3.4, 4.7, 4.10, 13.1.1, 13.4, A1.6.6',
