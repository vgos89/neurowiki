...
- **Block-lifting condition (clinical §17.2):** the 13 new citations set last_reviewed=2026-07-09 without a completable §13.6 verbatim-confirmation step (full-text egress blocked in the authoring environment; PMIDs/NBK IDs/quoted_text search-derived). Route evidence-verifier + medical-scientist to resolve every PMID/NBK/DOI and confirm each quoted_text verbatim once egress permits or V supplies full text; reconcile the 5 claim-vs-source specifics (hyperdense-MCA insensitivity, tonsillar 5mm, ASPECTS 10-region enumeration, gray-white "within hours" timing, acute-blood 50-70 vs 65-95 HU); reset last_reviewed to the real date; then re-submit to clinical-reviewer for the final gate. Merge to main stays gated until then.
