...
- **Status:** Phase 1 shipping this session; Phases 2–5 planned, `blocked:awaiting-V-approval` (one gate per phase).
...
- **Phase 1 — Class C-clinical [ACTIVE → done this session]:** Complete the closure history on `pfo-closure-cryptogenic` — attach 4 precursor RCTs (CLOSURE-I 2012, PC 2013, RESPECT original 2013, DEFENSE-PFO 2018); `trialCount` 3 → 7; `meta` rewrite to the missed-primary-endpoint → positive arc. No new trials/citations. clinical-reviewer approve — docs/reviews/clinical-pfo-closure-history-phase1.md.
