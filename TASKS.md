...
- **First pass: 67 recommendations across 21 mirror groups compared against the PDF. 8 disagreements, ALL CORRECTED 2026-08-04:**
  ...
  - **D8 NOT APPLIED, deliberately.** The extended-window time anchor reads "midpoint of sleep" where the source table appears to say "last known well". The verifier flagged that the (a)/(b) clauses read near-redundantly on a rendered PDF page and explicitly asked for a re-read at higher magnification before any edit. Not confident enough to change a thrombolysis time anchor. **Open.**
