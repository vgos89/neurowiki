...
- **Phase 3 — Class E [ ] blocked:awaiting-V-approval:** New question `pfo-closure-migraine` — MIST 2008, PRIMA 2015, PREMIUM 2017, pooled 2021; new synthesis; SEO route meta + JSON-LD schema + sitemap; system-architect (new-question structure) + seo-specialist + full clinical pipeline. Frame the SCAI-2022 "against routine closure for migraine" stance.
