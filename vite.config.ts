        ...
        VitePWA({
          ...
          workbox: {
            ...
            globIgnores: [
              ...
              '**/og-image.png',
              // 2026-05-22 (SPA pre-rendering Phase 2+3): exclude per-route
              // index.html files generated by scripts/prerender.mjs from the
              // Workbox precache manifest. These are crawler/SEO surfaces
              // (served by Vercel on initial request), not in-app navigation
              // targets — the SPA fetches the root index.html and navigates
              // client-side. Including 149 per-route HTML files at ~100 KB
              // each would balloon the precache by ~15 MB and exceed
              // Workbox's per-asset 2 MB cap on the larger pages. The root
              // dist/index.html remains precached.
